  ...
  "group/dropdown-menu-item relative flex cursor-default items-center outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      selectionMode: {
        ...
        single:
          "gap-2 rounded-none py-2 ps-2 pe-8 text-xs focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:ps-7 [&_svg:not([class*='size-'])]:size-4",
        multiple:
          "gap-2 rounded-none py-2 ps-2 pe-8 text-xs focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:ps-7 [&_svg:not([class*='size-'])]:size-4",
      },
    },
