...
function InputGroupCaret({
  className,
  ...props
}: React.ComponentProps<"span">) {
  return (
    <span
      data-slot="input-group-caret"
      aria-hidden="true"
      className={cn(
        "pointer-events-none invisible absolute top-1/2 caret -translate-y-1/2 group-focus-within/input-group:visible",
        className
      )}
      {...props}
    />
