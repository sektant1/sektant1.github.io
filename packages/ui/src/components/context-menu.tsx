...
> &
  ...
  return (
    <PopoverPrimitive
      ...
      className={cn(
        "data-entering:animate-in data-entering:fade-in-0 data-entering:zoom-in-95 data-exiting:animate-out data-exiting:fade-out-0 data-exiting:zoom-out-95 data-[placement=bottom]:slide-in-from-top-2 data-[placement=left]:slide-in-from-right-2 data-[placement=right]:slide-in-from-left-2 data-[placement=top]:slide-in-from-bottom-2 z-50 w-(--trigger-width) min-w-36 origin-(--trigger-anchor-point) overflow-x-hidden overflow-y-auto rounded-none bg-popover text-popover-foreground shadow-md ring-1 ring-foreground/10 duration-100 outline-none data-exiting:overflow-hidden **:data-[slot$=-item]:data-focused:bg-foreground/10",
        className
      )}
    >
      <MenuPrimitive
  ...
  "group/context-menu-item relative flex cursor-default items-center outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      selectionMode: {
        ...
        single:
          "gap-2 rounded-none py-2 ps-2 pe-8 text-xs focus:bg-accent focus:text-accent-foreground data-inset:ps-7 [&_svg:not([class*='size-'])]:size-4",
        multiple:
          "gap-2 rounded-none py-2 ps-2 pe-8 text-xs focus:bg-accent focus:text-accent-foreground data-inset:ps-7 [&_svg:not([class*='size-'])]:size-4",
      },
    },
