    ...
    <>
      ...
      <SiteShell
        ...
        status={[
          ...
          ...(meta.stack.length ? [{ label: "stack", value: meta.stack.join(" ") }] : []),
        ]}
      >
        <Article
          title={meta.title}
          ...
          tagBase={null}
          toc={toc}
          editHref={isAdminVisible() ? `/admin/projects/${meta.slug}/edit` : null}
          masthead={<ProjectMasthead meta={meta} />}
        >
          <MDXRemote source={project.body} components={createMdxComponents()} options={mdxOptions} />
          <EndOfFile />
        </Article>
      </SiteShell>
    </>
